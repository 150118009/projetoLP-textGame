...
public class TextGameMain {
	...
	public static Tree criarJogo() {
		...
		//jogo.inserir(1, 0, 0,"Este programa é um jogo de texto em que o utilizador decide o caminho ao preencher o número do caminho que pretende seguir",
		//			"Acordas-te numa floresta sem qualquer memória do teu passado e de como chegaste à floresta e decides: ");
		//jogo.inserir(1, 0, 1, "Não encontras ninguém e decides:", "Procurar ajuda");
		//jogo.inserir(2, 0, 1, "Consegues fazer uma fogueira e decides:", "Tentar fazer um fogueira com o isqueiro que tens no bolso e os ramos que estão no chão");
		//jogo.inserir(3, 0, 1, "O único mantimento que encontras são uns cogumelos junto à raiz de uma árvore:", "Procurar mantimentos");
